...
`07_BL_Q_Comparison.ipynb` 실행 결과 (2009~2025, 204개월):
...
→ 세부 내용: `07_BL_Q_Comparison_RESULTS.md`
...
├── 05_VolatilityPrediction.ipynb      → GARCH(1,1) vol 예측 → vol_predicted.csv
├── 06_Q_Sensitivity.ipynb             → 최적 Q 탐색 (GARCH + Baseline)
├── 07_BL_Q_Comparison.ipynb           → Q 방식 5종 비교 (Baseline vol)
├── 08_BL_VolQ_Grid.ipynb              → vol × Q 전체 격자 비교 (2×5)
...
├── 07_BL_Q_Comparison_RESULTS.md
├── 08_BL_VolQ_Grid_RESULTS.md
