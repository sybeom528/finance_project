...
- HO 24m: SPY = IT 집중 (AI rally) → ~~+21.2%~~ → **+21.07%** [정정 2026-05-12] / 펀드 = IT under-weight → ~~+8.3%~~ → **+7.20%** [정정 2026-05-12, 편측 20bp 적용] (열위)
...
**핵심 메시지**:
- HO 24m: ~~SPY +21.2% / 펀드 +8.3% (열위 -12.9%p)~~ → **SPY +21.07% / 펀드 +7.20% (열위 -13.87%p)** [정정 2026-05-12]
