...
> **📌 사후 정정 (2026-05-12)**: 본 표의 수치는 결정 당시 (2026-05-10) 의 원본 기록입니다.
> 이후 (1) TC override (편측 10bp → 20bp), (2) SPY NaN 보강 변경 발생.
> Dashboard 의 실제 표시값은 정정된 수치 (아래 [정정] 마커 참조).
> 자세한 이력: `updatelog.md` 의 "TC override 도입" + "SPY NaN 보강" 항목

| 메트릭 | TEST 168m | HOLD_OUT 24m | 비고 |
|---|---|---|---|
| sortino | (별도 산출) | ~~0.685~~ → **0.516** [정정 2026-05-12] | HO 부진 |
| sharpe | (별도 산출) | ~~0.397~~ → **0.302** [정정 2026-05-12] | HO 부진 |
| cagr | (별도 산출) | ~~+8.3%~~ → **+7.20%** [정정 2026-05-12] | ~~SPY +21.2%~~ → **SPY +21.07%** 대비 열위 |
| mdd | (별도 산출) | ~~-8.3%~~ → **-8.95%** [정정 2026-05-12] | SPY -7.6% 와 유사 |
| vol | (별도 산출) | 10.3% | — |
